      ...
      <main className="max-w-5xl mx-auto px-6 lg:px-8 pt-28 pb-12">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <article className="p-6 rounded-2xl bg-[linear-gradient(135deg,rgba(255,255,255,0.02),rgba(255,255,255,0.03))] border border-glass-border">
            ...
            <div className="mt-4">
              <Link href="/ras/labs/drone" className="px-4 py-2 rounded-md bg-accent-cyan text-black font-semibold">Open Drone Lab</Link>
            </div>
          </article>
          ...
          <article className="p-6 rounded-2xl bg-[linear-gradient(135deg,rgba(255,255,255,0.02),rgba(255,255,255,0.03))] border border-glass-border">
            ...
            <div className="mt-4">
              <Link href="/ras/labs/satellite" className="px-4 py-2 rounded-md bg-accent-cyan text-black font-semibold">Open Satellite Lab</Link>
            </div>
          </article>
        </div>
      </main>
